...
export function BlockWalletModal({ closeModal }: { closeModal: any }) {
  ...
  return (
    <div className="w-[500px] text-center space-y-9 p-8">
      <div className="space-y-2">
        <h1 className="md:text-xl font-semibold text-primary-color">Block Wallet</h1>

        <p className="text-gray-500">Why are you blocking this users wallet??</p>
      </div>
